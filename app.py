...
def calculate():
    ...
    return render_template('resume.html',image=img,name=name,post=post,email=email,address=address,skills=skills,certification_one=certification_one,certification_two=certification_two,
